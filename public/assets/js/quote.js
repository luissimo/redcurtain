...
$(document).on('keyup', '#factuurnummer_input', function() {
    ...
    date_1 = $("#quote_date_1i");
    date_2 = $("#quote_date_2i");
    date_3 = $("#quote_date_3i");
...
date_1.change(function()
{
    ...
    duedate_1 = $("#quote_duedate_1i");
    duedate_2 = $("#quote_duedate_2i");
    duedate_3 = $("#quote_duedate_3i");
...
$(document).ready(function() {
    ...
    $('#add_products').click(function() {
        $('.products_tr:last').after('<tr class="products_tr"><td><input class="quantity form-control" type="text" value="" name="quote[items_attributes]['+counter+'][quantity]"></td>' +
            '<td><textarea class="form-control" name="quote[items_attributes]['+counter+'][description]"></textarea></td>' +
            '<td><input id="unitprice" class="unitprice form-control" type="text" name="quote[items_attributes]['+counter+'][unitprice]"></td>' +
            '<td class="row_total"></td>' +
            '<td><select class="btw_percentage" name="quote[items_attributes]['+counter+'][btw]"><option title="21%" value="21"> 21%</option> ' +
